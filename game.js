...
const GITHUB_USER = 'C0demachine';
const GITHUB_REPO = 'clickmaster';
...
let updateAvailable = false, knownSHA = null;
...
if (knownSHA === null) { knownSHA = latestSHA; return; }
const btn = document.getElementById('updateBtn');
if (latestSHA !== knownSHA && !updateAvailable) {
updateAvailable = true;
btn.textContent = '▲ UPDATE READY'; btn.classList.add('has-update');
showNotif('UPDATE AVAILABLE — TAP UPDATE READY!');
}
} catch(e) {}
}
...
showNotif('RELOADING...'); setTimeout(() => location.reload(true), 600);
}
